...
function styles_theme() {
  ...
  wp_register_style( 'styles_theme4', get_template_directory_uri() .'/library/lightgallery_2/css/lightgallery-bundle.css' );
  wp_register_style( 'styles_theme5', get_template_directory_uri() .'/css/style.css', '3.0', true);
...
function scripts_theme() {
  ...
  wp_register_script('scripts_theme4b', get_template_directory_uri() . '/library/lightgallery_2/plugins/video/lg-video.min.js' );
  wp_register_script('scripts_theme4c', 'https://player.vimeo.com/api/player.js' );
  ...
  // wp_register_script('scripts_theme10', get_template_directory_uri() . '/js/backgroundVideo.js' );
	...
	// MAIN
	wp_register_script('scripts_theme12', get_template_directory_uri() . '/js/main.js', '', 3.0 , true  );
  ...
  wp_enqueue_script('scripts_theme4b');
  wp_enqueue_script('scripts_theme4c');
...
function my_theme_add_scripts() {
  wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDg9OkJZ6kPDrHghixG4_vtGXHNlcYOO1A' );
...
function my_acf_init() {
    acf_update_setting('google_api_key', 'AIzaSyDg9OkJZ6kPDrHghixG4_vtGXHNlcYOO1A');
}
...
$languages = icl_get_languages('skip_missing=1');
  if(1 < count($languages)){
    foreach($languages as $code => $l){
      if(!$l['active']) $langs[] = '<li><a href="'.$l['url'].'">'.$code.'</a></li>';
      if($l['active']) $langs[] = '<li><span>'.$code.'</span></li>';
    }
    echo join($langs);
  }
}
